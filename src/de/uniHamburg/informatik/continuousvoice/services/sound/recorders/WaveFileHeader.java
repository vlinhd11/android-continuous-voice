...
public class WaveFileHeader {
    public final int HEADER_LENGTH = 44;
    private byte[] header = new byte[HEADER_LENGTH];

    public WaveFileHeader(long totalAudioLen, long longSampleRate, int channels, long byteRate, byte audio_encoding_bits) { //16
        ...
        header[33] = 0;
        header[34] = audio_encoding_bits; // bits per sample
        header[35] = 0;
        header[36] = 'd';
        header[37] = 'a';
        header[38] = 't';
