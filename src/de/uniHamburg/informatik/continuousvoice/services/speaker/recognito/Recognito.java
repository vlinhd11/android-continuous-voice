 ...
 *
 */
package de.uniHamburg.informatik.continuousvoice.services.speaker.recognito;
...
import de.uniHamburg.informatik.continuousvoice.services.speaker.recognito.distances.DistanceCalculator;
import de.uniHamburg.informatik.continuousvoice.services.speaker.recognito.distances.EuclideanDistanceCalculator;
import de.uniHamburg.informatik.continuousvoice.services.speaker.recognito.enhancements.Normalizer;
import de.uniHamburg.informatik.continuousvoice.services.speaker.recognito.features.FeaturesExtractor;
import de.uniHamburg.informatik.continuousvoice.services.speaker.recognito.features.LpcFeaturesExtractor;
import de.uniHamburg.informatik.continuousvoice.services.speaker.recognito.utils.FileHelper;
import de.uniHamburg.informatik.continuousvoice.services.speaker.recognito.vad.AutocorrellatedVoiceActivityDetector;
...
public class Recognito<K> {
    ...
    public VoicePrint createVoicePrint(K userKey, File voiceSampleFile) 
        ...
        double[] audioSample = FileHelper.readAudioInputStream(voiceSampleFile);
